                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <form action="{{ route('admin.user_permission_type.index') }}" method="GET" class="d-flex" no-auto>
                                <input
                                    type="text"
                                    name="search"
                                ...
                                @if(!empty($search))
                                              <a href="{{ route('admin.user_permission_type.index') }}" class="btn btn-secondary">
                                              @lang('words.clear')
                                              </a>
                                 @endif
                            </form>
                        ...
                        <div class="table-responsive">
                                        ...
                                        <tr class="hover:bg-gray-100">
                                            ...
                                            <td>
                                             <div class="d-flex align-items-center gap-1">
                                                 ...
                                                 <form no-auto action="{{ route('admin.user_permission_type.delete', $user_permission_type->id) }}" method="POST"
                            ...
                            <div class="mt-3 d-flex justify-content-center">
                                {{ $user_permission_types->links('pagination::bootstrap-5') }}
                            </div>
                        </div>
                    </div>
                </div>
